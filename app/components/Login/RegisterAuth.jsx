    ...
    <form className='flex flex-col items-center gap-1'>
      <div className='flex flex-col gap-4 justify-center items-center w-full '>
        <div className='flex flex-col items-start w-full'>
          ...
          <input required className='bg-primary-400 rounded-full px-3 py-2 font-semibold text-base text-black w-full outline-none placeholder:text-black placeholder:text-opacity-50' type='text' placeholder='Type here...' id='name' value={displayName} onChange={e => setDisplayName(e.target.value)} />
        </div>
        <div className='flex flex-col items-start w-full'>
          <label className='text-lg font-extrabold text-white' htmlFor='email'>Email</label>
          <input required className='bg-primary-400 rounded-full px-3 py-2 font-semibold text-base text-black w-full outline-none placeholder:text-black placeholder:text-opacity-50' type='email' placeholder='Type here...' id='email' onChange={e => setEmail(e.target.value)} value={email} />
        </div>
        <div className='flex flex-col items-start w-full'>
