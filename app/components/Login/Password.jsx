  ...
  return (
    <>
      ...
      <div className='flex items-center bg-primary-400 px-3 py-2 rounded-full w-full'>
        <input autoComplete='on' className='bg-primary-400 font-medium text-sm text-white w-full outline-none ' type={visible ? 'text' : 'password'} placeholder='Type here...' id={htmlFor} />
