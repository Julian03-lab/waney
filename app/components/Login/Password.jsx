  ...
  return (
    <>
      ...
      <div className='flex items-center bg-primary-400 px-3 py-2 rounded-full w-full justify-center'>
        <input required autoComplete='on' className='bg-primary-400 font-semibold text-base text-black w-full outline-none placeholder:text-black placeholder:text-opacity-50' type={visible ? 'text' : 'password'} placeholder='********' id={htmlFor} onChange={htmlFor === 'password' ? handlePassword : handleConfirm} />
